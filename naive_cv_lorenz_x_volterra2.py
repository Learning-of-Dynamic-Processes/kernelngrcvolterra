...
if __name__ == "__main__":
    ...
    ld_coef_range = np.linspace(0.5, 0.95, 10).round(2)
    tau_coef_range = np.linspace(0.5, 0.95, 10),round(2)
    reg_range = np.logspace(-15, -5, 11)
    ...
    CV = CrossValidate(validation_parameters=[2500, 500, 500], validation_type="rolling", 
                       ...
                       error_type="specdens", log_interval=100)
