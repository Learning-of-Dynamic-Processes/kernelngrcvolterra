...
ld_coef_range = np.linspace(0.01, 1, 50)
tau_coef_range = np.linspace(0.01, 1, 50)
...
if __name__ == "__main__":
    ...
    best_parameters, parameter_combinations, errors = CV.crossvalidate_multiprocessing(Volterra, train_in_volt, train_teach_volt, param_ranges, param_names, param_add, num_processes=5)
